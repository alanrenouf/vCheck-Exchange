...
# Add Header resource
Add-ReportResource "Header" ($StylePath + "\Header.png") -Used $true
...
<html><head><title>_HEADER_</title>
	...
	<a name='top'></a>
<div style='font-family:Arial, Helvetica, sans-serif; font-size:20px; font-weight:bolder; background-color:#FFFFFF; border: 3px solid #$($Colour1)'>
<p class='accent'>
<!--[if gte mso 9]>
